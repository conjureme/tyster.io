...
const projects: Project[] = [
  ...
  {
    id: 2,
    title: 'to be named bot project',
    description:
      'a super awesome discord chatbot that lets you customize its persona and capabilities. also comes with extra fine-tuned control for power users!',
    icon: '/club.svg',
